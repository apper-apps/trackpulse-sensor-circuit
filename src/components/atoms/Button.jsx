...
const variants = {
    primary: 'bg-gradient-emerald text-white hover:shadow-lg focus:ring-emerald-500 hover:scale-105',
    secondary: 'bg-white text-slate-700 border border-slate-300 hover:bg-slate-50 focus:ring-emerald-500 hover:border-slate-400',
    outline: 'bg-transparent text-emerald-600 border border-emerald-300 hover:bg-emerald-50 focus:ring-emerald-500',
